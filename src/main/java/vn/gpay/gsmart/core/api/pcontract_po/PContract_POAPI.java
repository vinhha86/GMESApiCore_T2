...
//						String Shipmode = row.getCell(ColumnPO.Shipmode) == null ? "" : row.getCell(ColumnPO.Shipmode).getStringCellValue().trim();
...
//						String PackingMethod =  row.getCell(ColumnPO.PackingMethod) == null ? "" : row.getCell(ColumnPO.PackingMethod).getStringCellValue().replace("\n", "").replace("\r", "").trim();
